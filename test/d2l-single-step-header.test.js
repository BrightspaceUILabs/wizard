...
describe('d2l-labs-single-step-header', function() {
	...
	describe('first', () => {
		it('should have class name first', async() => {
			...
			expect(elem.shadowRoot.children[0].className).to.equal('d2l-single-step-header-first ');
		});
	});
	...
	describe('last', () => {
		it('should have class name last', async() => {
			...
			expect(elem.shadowRoot.children[0].className).to.equal(' d2l-single-step-header-last');
		});
	});
	...
	describe('first and last', () => {
		it('should have class name first and last', async() => {
			...
			expect(elem.shadowRoot.children[0].className).to.equal('d2l-single-step-header-first d2l-single-step-header-last');
		});
	});
